    ...
    return (
        <div>
            ...
            <OptionBlock title="Attributions">
                ...
                <br/>
                <br/>
                This app is primarily built using <a href="https://react.dev/" target="_blank">React</a> and <a href="https://nextjs.org/" target="_blank">NextJS</a> with <a href="https://github.com/ThePhar/archipelago.js" target="_blank">Archipelago.js</a> to connect to Archipelago. <br/>
                More information about other libraries used and their licenses can be found on this project's <a href="https://github.com/DrAwesome4333/ap-tracker" target="_blank">GitHub repository</a>. Please report any problems you find there.
            </OptionBlock>
            <StickySpacer />
        </div>
    );
